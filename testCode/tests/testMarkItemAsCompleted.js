module.exports = {
  ...
  '6. Verify only the marked item has changed': function(client){
      this.theWebpage.getTodoList(function(returnList){
        client.verify.deepEqual(returnList,this.currentList, "Making sure the item got marked as completed.");
      }.bind(this));
  },

  '7. Get Performance Logs': function (client) {
