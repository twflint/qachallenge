...
module.exports = {
  ...
  '4. Add a todo list items': function(client) {
    let newTextList = ["http://www.google.com","<i>Hello World</i>","!@#$%^&*()_+-={}[]|:;<>,.?~`","all lowercase","ALL UPERCASE","VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY EXTREEMLY LONG TEXT OF 128 CHARACTERS!", "VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY VERY EXTREEMLY LONG TEXT OF 256 CHARACTERS!!!!"];
    SYNC_LOOP(newTextList.length, function(loop){
      this.theWebpage.newTodo.enterValueWithEnter(newTextList[loop.iteration()], function(){
        this.currentList.push([newTextList[loop.iteration()],false]);
        loop.next();
      }.bind(this));
    }.bind(this));
  },

  '5. Verify all the text examples got added as is': function(client){
    this.theWebpage.getTodoList(function(returnList){
  ...
  '6. Get count of items left': function(client){
    this.theWebpage.getCountOfItemsLeft(function(returnItemsLeft){
      client.verify.equal(returnItemsLeft, "7 items left", "Verifying the number of items not completed.");
    });
  },
